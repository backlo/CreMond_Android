    ...
    private class NumberAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 10: cur_fragment = new NumberFragment("이십","Hai mươi",R.raw.number_twenty_korean,R.raw.number_twenty_vietnamese,R.drawable.number_twenty); break;
                case 11: cur_fragment = new NumberFragment("삼십","Ba mươi",R.raw.number_thirty_korean,R.raw.number_thirty_vietnamese,R.drawable.number_thirty); break;
                case 12: cur_fragment = new NumberFragment("사십","Bốn mươi",R.raw.number_forty_korean,R.raw.number_forty_vietnamese,R.drawable.number_forty); break;
                case 13: cur_fragment = new NumberFragment("오십","Năm mươi",R.raw.number_fifty_korean,R.raw.number_fifty_vietnamese,R.drawable.number_fifty); break;
                case 14: cur_fragment = new NumberFragment("육십","Sáu mươi",R.raw.number_sixty_korean,R.raw.number_sixty_vietnamese,R.drawable.number_sixty); break;
                case 15: cur_fragment = new NumberFragment("칠십","Bảy mươi",R.raw.number_seventy_korean,R.raw.number_seventy_vietnamese,R.drawable.number_seventy); break;
                case 16: cur_fragment = new NumberFragment("팔십","Tám mươi",R.raw.number_eighty_korean,R.raw.number_eighty_vietnamese,R.drawable.number_eighty); break;
                case 17: cur_fragment = new NumberFragment("구십","Chín mươi",R.raw.number_ninety_korean,R.raw.number_ninety_vietnamese,R.drawable.number_ninety); break;
                case 18: cur_fragment = new NumberFragment("백","Một mươi",R.raw.number_hundred_korean,R.raw.number_hundred_vietnamese,R.drawable.number_hundred); break;
            }
            return cur_fragment;
        }
